...
void solve() {
    ...
    int costFirst = 0, costLast = 0, costFullCover = 0;
    fo(i, 0, n) {
        int l, r, c; cin>>l>>r>>c;
        if(l == first && r == last) {
            if(fullCover) {
                if(costFullCover >= c) {
                    costFullCover = costLast = costFirst = c;
                }
            } else {
                if(c <= costFirst+costLast) {
                    costFullCover = costLast = costFirst = c;
                    fullCover = true;
            ...
            fullCover = true;
            last = r;
            costFirst = costLast = costFullCover = c;
        } else if(r == last && l < first) {
            fullCover = true;
            first = l;
            costFirst = costLast = costFullCover = c;
        } else if(l == first && r < last) {
            if(fullCover) {
                if(costFullCover > c + costLast) {
                    fullCover = false;
                    costFirst = c;
                }
            } else {
        ...
        if(fullCover) cout<<costFullCover;
        else cout<<(costLast+costFirst);
        cout<<endl;
    }
}
